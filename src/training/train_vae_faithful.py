"""
Training script for VAE Faithful model.
"""
...
def train_vae(
    ...
    # Initialize tokenizer (using a simple one for demo)
    ...
    print("\nTraining completed!")
    print(f"Final KL: {avg_kl:.4f} (should be 5-20, not 100)")
    print(f"Final Recon: {avg_recon:.4f} (should be decreasing)")
